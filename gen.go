...
func main() {
	...
	fmt.Fprintf(bw, "// Code generated by \"stringer %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	fmt.Fprintf(bw, outputHardCoded)
	...
	err = os.WriteFile("schema_output.go", src, 0644)
	check(err)
